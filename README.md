...
These models have been run on a 2015 Macbook Pro and also on a 12-core Ubuntu 16.10 workstation. If you have the TLA+ tools installed you can run them all by running the `checkall.sh` script. Below are the various statistics for each model checking run.

**2015 Macbook Pro, 3.1 GHz Intel Core i7, 16 GB 1867 MHz DDR3, 3 TLC workers**
```
results/1_LearnCommitPoint.cfg.out
...
results/1_LearnCommitPointFromSyncSource_3_node.cfg.out
...
results/1_LearnCommitPointFromSyncSource_3_node_noinv.cfg.out
...
results/1_LearnCommitPointFromSyncSource_5_node.cfg.out
...
results/1_LearnCommitPointFromSyncSource_5_node_noinv.cfg.out
...
results/1_LearnCommitPoint_noinv.cfg.out
...
results/2_MultiNodeSyncSourceCycle.cfg.out
...
results/3_CommitPointPropagationLiveness.cfg.out
